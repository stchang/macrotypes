...
# Setup script for POPL 2020 artifact, "Dependent Type Systems as Macros"

## -----------------------------------------------------------------------------
# Global variables

RKT_INSTALLER="racket-7.4-x86_64-linux.sh"
ARTIFACT="popl2020-artifact"
...
cd ~
# first download Racket v7.4
wget https://mirror.racket-lang.org/installers/7.4/${RKT_INSTALLER}
