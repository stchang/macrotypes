#lang s-exp "../../dep/dep-ind-cur2.rkt"
(require "../../dep/dep-ind-cur2+data.rkt"
         "../../dep/dep-ind-cur2+sugar.rkt"
         "../rackunit-typechecking.rkt")

; Π → λ ∀ ≻ ⊢ ≫ ⇒

;; mostly the same as dep-ind-eq-tests.rkt (which uses #lang dep-ind-fixed.rkt)
;; - except with auto curry/uncurrying
